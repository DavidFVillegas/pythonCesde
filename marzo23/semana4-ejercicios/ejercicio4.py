...
Si desea añadir un nuevo pedido, se le preguntara el numero del pedido y el costo del pedido y se agregara al diccionario.
...
while True:
    ...
    if accion.upper() == 'A':
        ...
        print("Acción no reconocida. Por favor, introduce A para añadir un pedido, P para pagar un pedido o T para terminar.")
